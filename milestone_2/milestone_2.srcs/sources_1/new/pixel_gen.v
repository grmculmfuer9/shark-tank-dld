...
//        drawing the pipes
 ...
 //        painting the rest of the background white
         begin
red   <= video_on ? 4'h0 : 4'h0;  // Red component is set to zero
green <= video_on ? 4'hF : 4'h0;  // Green component is set to maximum (15)
blue  <= video_on ? 4'hF : 4'h0;  // Blue component is set to maximum (15)
